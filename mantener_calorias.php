...
<body>
    ...
    <input type="hidden" id="peso" value="<?php echo $_POST['peso'];?>" >
      ...
      <br/>
      <div class="warp">
    <input class="botones sedentario" type="button" value="Sedentario" onClick="calculoCal(12)">
   
    <input class="botones activo" type="button" value="Activo" onClick="calculoCal(14)">
    
    <input class="botones muy_activo" type="button" value="Muy activo" onClick="calculoCal(16)">
    </div>
